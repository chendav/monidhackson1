...
colors:
  ...
  text-muted: "#173748"
  text-light: "#9A9A9A"
  accent-light: "rgba(23, 66, 95, 0.08)"
  accent-medium: "rgba(23, 66, 95, 0.15)"
  border: "rgba(23, 66, 95, 0.2)"
  card-bg: "rgba(23, 66, 95, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  ...
  h4-eyebrow:{ fontFamily: "Arial", cqw: 0.8, weight: 600, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "Arial", px: 12, weight: 600, color: "primary" }
  counter: { fontFamily: "Arial", px: 13, weight: 600, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (Arial, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "Arial", cqw: 1.25, weight: 600, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "Arial", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "Arial", cqw: 2.4, weight: 600, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "Arial", cqw: 2.6, weight: 600, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
...
- **Fonts** — already set to **Arial** (display) / **SFMono-Regular** (body); ignore any preset font name lingering in prose.
- **Weights** — the brand font ships `{400, 600, 700, 760, 800, 850, 900}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
