...
export const DETERMINISTIC_REGRESSION_CASES = Object.freeze([
  ...
  Object.freeze({ id: "source-binding-and-submission-safety", file: "tests/unit/record-authority.test.ts", pattern: "T7 record-bound semantic authority|T9 source-ledger package authority|T16 deterministic Monid-to-PDF.js source binding|T17 selector-scoped physical alignment|T21 selector-authenticated presentation materialization|T24 server-positioned exact source quotes|T25 server-owned issued evidence origins", expectedExecuted: 97, expectedIdentitySha256: "1dbbffe444e9251f96b78cf0fae38a4de6fcbf41d1b7c50d58997efd9582523b" }),
  Object.freeze({ id: "structured-output-completeness-and-usage", file: "tests/unit/openai-adapter.test.ts", pattern: "OpenAI Responses structured output adapter", expectedExecuted: 55, expectedIdentitySha256: "418b3bc27a1e6b3ba3b551957c69dd6553831dc0fd215e16766d50513632ba25" }),
